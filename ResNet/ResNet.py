# -*- coding: utf-8 -*-
"""
Created on Mon Sep 27 14:02:45 2017
...
def resnet_arg_scope(is_training=True, weight_decay=0.0001, batch_norm_decay=0.997, batch_norm_epsilon=1e-5, batch_norm_scale=True):
	...
	with slim.arg_scope(
		...
		weights_regularizer=slim.variance_scaling_initializer(),
...
@slim.add_arg_scope
def bottleneck(inputs, depth, depth_bottleneck, stride, outputs_collections=None, scope):
...
#根据不同的ResNet网络配置，设计层数分别是50、101、152、200的ResNet
#以下为50层的ResNet
